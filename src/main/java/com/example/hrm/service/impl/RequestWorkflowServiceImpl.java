...
@Service
@Transactional
public class RequestWorkflowServiceImpl implements RequestWorkflowService {
    ...
    public RequestWorkflowServiceImpl(LeaveOrOtRequestRepository requestRepository,
