...
@Service
public class LeaveOrOtRequestServiceImpl implements LeaveOrOtRequestService {

    private final LeaveOrOtRequestRepository repository;

    public LeaveOrOtRequestServiceImpl(LeaveOrOtRequestRepository repository) {
    ...
    @Override
    public List<LeaveOrOtRequest> getMyRequests(Integer empId) {
