...
@Service
public class MonthlyScheduleBatchService {

    private final MonthlyScheduleBatchRepository repository;
    private final UserRepository userRepository;
    private final EmployeeRepository employeeRepository;

    public MonthlyScheduleBatchService(MonthlyScheduleBatchRepository repository,
    ...
    public MonthlyScheduleBatch create(MonthlyScheduleBatchFormDTO form) {
        ...
        YearMonth ym;
        try {
            ym = YearMonth.parse(form.getScheduleMonth()); // yyyy-MM
        } catch (Exception e) {
