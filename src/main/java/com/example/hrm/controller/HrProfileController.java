...
public class HrProfileController {
    ...
    public HrProfileController(UserRepository userRepo, EmployeeRepository employeeRepo) {
    ...
    public String profile(Authentication auth, Model model) {
        String principal = (auth == null) ? null : auth.getName(); // thường là username hoặc email
        ...
        return "hr/profile"; // templates/hr/profile.html
    }
}
